...
export function CombinedCarousel() {
  ...
  const [emblaApi2, setEmblaApi2] = useState(null);
  ...
  return (
    <div className="relative w-full mx-auto  px-20 py-5 ">
      <div className="flex">
        {/* Vertical Carousel */}
        <div className="flex  ">
          <Carousel
        ...
        >
          ...
          <CarouselPrevious className="top-[350px] left-0 bg-gray-300" />
          <CarouselNext className="top-[350px] left-12 bg-gray-300" />
        </Carousel>
      </div>
    </div>
  );
